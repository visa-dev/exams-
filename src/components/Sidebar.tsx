  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <h2 className='text-primary'>UNIVERSITY OF VAVAUNIYA</h2>
        </NavLink>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav className="mt-5 py-2 px-4 lg:mt-2 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path
                      d="M3 13H11V3H3V13ZM3 21H11V17H3V21ZM13 21H21V11H13V21ZM13 3V9H21V3H13Z"
                      fill="currentColor"
                    />
                  </svg>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/application' || pathname.includes('application')
                }
              >
                {(handleClick, open) => {
                  return (
